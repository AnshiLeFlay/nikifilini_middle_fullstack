...
export default class OrdersListState {
    ...
    constructor() {
        ...
        if (currentPage) this.page = parseInt(currentPage);
    }
    ...
    async loadOrders() {
        ...
        await client
            ...
            .then((res: any) => {
                console.log(res);
                this.orders = res.data.getOrders.orders;
                //this.page = res.data.getOrders.pagination.currentPage;
                this.totalPages = res.data.getOrders.pagination.totalPageCount;
            })
            .catch((err: any) => {
                console.log(err);
            });
